var cumberbatch = {
	names: {
		first: [
			...
			"Bacardi", "Bagleface", "Benedick", "Billyboy", "Blueberry", "Blunderbrick", "Bobafett", "Bumblesnuff", "Butterscotch", "Dumbledore", "Engelbert", "Longdong", "Massachusetts", "Quitsack", "Ragnarök"
		],
		last: [
			...
			"Cabbagewank", "Candywrap", "Crunchypants", "Cucumberbatch", "Pantypants", "Pantysniffer", "Rummelsnuff", "Thundercats"
		],
		full: [

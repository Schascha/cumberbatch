var cumberbatch = {
	names: {
		first: [
			...
			"Bacardi", "Bagleface", "Benedick", "Billyboy", "Blueberry", "Blunderbrick", "Bobafett", "Bumblesnuff", "Butterscotch", "Dumbledore", "Engelbert", "Igglybuff", "Longdong", "Massachusetts", "Quitsack", "Ragnarök"
		],
		last: [
			...
			"Cabbagewank", "Candywrap", "Centipede", "Crunchypants", "Cucumberbatch", "Fluffeluff", "Pantypants", "Pantysniffer", "Rummelsnuff", "Scamander", "Thundercats"
		],
		full: [
